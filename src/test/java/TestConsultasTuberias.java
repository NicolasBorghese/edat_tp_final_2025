...
public class TestConsultasTuberias {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(BOLD + "Predicción: \n" + "Camino:" + YELLOW + "Caviahue->Neuquén->Chocón->Las Grutas \n"
                + RESET + BOLD + "Estado: " + RESET + RED + "EN REPARACIÓN" + RESET);
        System.out.println(BOLD + PURPLE + "Resultado: \n" + RESET
                + ConsultasTuberia.getCaminoMasCorto(arbolCiudades, grafoCiudades, hashTuberias, "Caviahue",
                        "Las Grutas"));
        ...
        System.out.println(BOLD + PURPLE + "Camino con mayor caudal pleno entre Caviahue y San Martín." + RESET);
        System.out.println(
                BOLD + "Predicción: \n" + "Camino:" + YELLOW
                        + "Caviahue->Neuquén->Cipolletti->Allen->Chocón->Bariloche->San Martín. \n"
                        + RESET + BOLD + "Estado: " + RESET + CYAN + "EN DISEÑO \n" + RESET + BOLD + "Caudal: "
                        + RESET + BLUE + "123" + RESET);
        System.out.println(BOLD + "Resultado: \n" + RESET + ConsultasTuberia.getCaminoConMayorCaudalPleno(arbolCiudades,
                grafoCiudades, hashTuberias, "Caviahue", "San Martín de los andes"));
        // Camino con menor caudal pleno con Ciudad Origen inexistente.
        System.out.println(BOLD + PURPLE + "Camino con mayor caudal pleno entre Springfield y San Martín." + RESET);
        System.out.println(
        ...
        System.out.println(BOLD + PURPLE + "Camino con mayor caudal pleno entre Caviahue y Springfield." + RESET);
        System.out.println(
                BOLD + "Predicción: \n" + RED + "Una o ambas ciudades inexistentes." + RESET);
        System.out.println(BOLD + "Resultado: \n" + RESET + ConsultasTuberia.getCaminoConMayorCaudalPleno(arbolCiudades,
                grafoCiudades, hashTuberias, "Caviahue", "Springfield"));
        // Camino con menor caudal pleno con ambas Ciudades inexistentes.
        System.out.println(BOLD + PURPLE + "Camino con mayor caudal pleno entre Springfield y South Park." + RESET);
        System.out.println(
                BOLD + "Predicción: \n" + RED + "Una o ambas ciudades inexistentes." + RESET);
        System.out.println(BOLD + "Resultado: \n" + RESET + ConsultasTuberia.getCaminoConMayorCaudalPleno(arbolCiudades,
                grafoCiudades, hashTuberias, "Springfield", "South Park"));
        ...
        System.out.println(BOLD + GREEN + "Todas las consultas que se hacen a las tuberías están testeadas y funcionan \n :)" + RESET);
    }
